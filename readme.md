...
|<kbd>Ctrl</kbd>+<kbd>]</kbd> and <kbd>Ctrl</kbd>+<kbd>[</kbd>|adjust indent|<kbd>Command</kbd>+<kbd>Alt</kbd>+<kbd>L</kbd> and [Wrapping and Braces](https://stackoverflow.com/questions/57302273/how-to-split-one-very-long-line-in-pycharm-into-multiple-lines)|break long line|
|<kbd>Alt</kbd>+<kbd>z</kbd>|break long line|<kbd>Alt</kbd>+<kbd>enter</kbd>|reformat code|
